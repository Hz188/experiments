...
int main() {
  ...
  // algorithm
    ...
    using algo_t = cudnnConvolutionFwdAlgo_t;
        ...
        int algo;
        cudnnGetConvolutionForwardAlgorithm_v7(cudnn, in_desc, filt_desc, conv_desc,
                                               out_desc, num_algos ,&algo,perf_results.get());
...
//        CUDNN_CONVOLUTION_FWD_PREFER_FASTEST, 0, &algo));  //cudnn 9 api有变化
  ...
  CUDNN_CALL(cudnnGetConvolutionForwardWorkspaceSize(
        cudnn, in_desc, filt_desc, conv_desc, out_desc, algos[algo], &ws_size));
  ...
  CUDNN_CALL(cudnnConvolutionForward(
      ...
      conv_desc, algos[algo], ws_data, ws_size,

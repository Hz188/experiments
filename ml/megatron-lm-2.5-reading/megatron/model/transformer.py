...
class ParallelMLP(MegatronModule):
    ...
    def __init__(self, init_method, output_layer_init_method):
        ...
        self.dense_h_to_4h = mpu.ColumnParallelLinear( # 列切分
            ...
            gather_output=False, # 这里false，采用第二种方案
...
class ParallelTransformerLayer(MegatronModule):
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        attention_output, attention_bias = \
            self.self_attention(layernorm_output, # 对输入进行处理
                                attention_mask,
        ...
        with torch.enable_grad():  # dropout操作
        ...
        # re-enable torch grad to enable fused optimization.
        with torch.enable_grad():
            output = bias_dropout_add_func(  # dropout操作 这里是dropout+add的fused操作 残差加法操作也在这里
                mlp_output,
...
class ParallelTransformer(MegatronModule):
    ...
    def __init__(self, init_method, output_layer_init_method,
        ...
        # args.num_layers = 24 ，4阶段流水线
        # 24 / 4 = 6 一个GPU上放 6层 Transformer
        self.num_layers = args.num_layers // mpu.get_pipeline_model_parallel_world_size()  # 获得本Transformer的具体层数
        # Transformer layers.

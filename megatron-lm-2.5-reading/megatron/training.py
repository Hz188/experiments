...
def pretrain(train_valid_test_dataset_provider,
    ...
    # Data stuff.  调用train_val_test_data_provider获取train/val/test数据集
...
def get_model(model_provider_func):
    ...
    if args.DDP_impl == 'torch': # 如果需要数据并行，则配置DDP
    ...
    if args.DDP_impl == 'local':  # 如果需要数据并行，则配置DDP  这里是megatron自己的DDP实现

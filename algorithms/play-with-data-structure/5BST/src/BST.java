...
//        return false;
        ...
        //  非递归 version2
        while (node != null && e.compareTo(node.e) != 0) {
            if (e.compareTo(node.e) < 0) {
                node = node.left;
            } else {
                node = node.right;
...
//            size--;
            ...
            //思路2 找到后继结点后 将后继结点删除，当前节点的值改为后继结点的值，就不用再更改结点间的连接关系了
    ...
    public void removeNR(E e) {
        ...
        //TODO 未完成 非递归的删除 挑战程序设计竞赛里 node 维护了一个 parent属性，指向父节点，方便实现
